...
export  class ProductDetails extends Component {
  ...
  // const Content = (props) => {
    ...
    return (
     ...
     <Image
                    style={{flex:1,width: "100%", height: calcHeight (150) ,alignItems:'center',alignSelf:'center'}}

                    source={require('../img/steelproduct.jpg')}

                />
  
      <View style={{flex:1,marginTop:25,backgroundColor:'#1F456E',borderTopRightRadius:25,borderTopLeftRadius:25}}>
      <View style={{flex:2}}>
...
<View style={{flexDirection:'row',marginRight:20,marginTop:14}}>
      ...
      <Text style={plus.col}>-</Text>
       ...
       <Text style={{fontSize:15,marginLeft:20,marginTop:4,color:'white'}}>is an alloy of iron and carbon containing less than 2% carbon and 1% manganese and small amounts of silicon, phosphorus, sulphur and oxygen. Steel is the world's most important engineering and construction material.
       </Text> 
